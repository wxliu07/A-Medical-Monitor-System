...
class FaceUtilities:
    ...
    def facial_landmarks_remap(self, shape):
        ...
        # to use remapped_shape mask = np.zeros((face_frame.shape[0], face_frame.shape[1])) #create a black rectangle
        # mask with w, h of the face cv2.fillConvexPoly(mask, remapped_shape[0:27], 1) #fill convex to the mask with
        # remapped_shape
